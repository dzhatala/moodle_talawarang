...
$string['deleteannotation'] = 'Hapus annotation';
$string['deletecomment'] = 'Hapus comment';
$string['deletefeedback'] = 'Hapus feedback PDF';
...
$string['tool'] = 'Tool';
$string['viewfeedbackonline'] = 'Lihat PDF hasil koreksi';
$string['white'] = 'White';
