...
$string['allowsubmissionsfromdatesummary'] = 'Tugas/assignment ini bisa dikumpulkan dari <strong>{$a}</strong>';
...
$string['duedate'] = 'Batas Waktu Akhir';
...
$string['editsubmission'] = 'Rubah pelaporan/pengiriman';
$string['editsubmissionother'] = 'Edit submission for {$a}';
$string['editsubmission_help'] = 'Rubah laporan Anda';
...
$string['filesubmissions'] = 'Pengiriman/Upload file';
...
$string['submissionstatusheading'] = 'Status Pelaporan/Pekerjaan';
...
$string['submissionstatus'] = 'Status Pelaporan/Pekerjaan';
$string['submissionstatus_submitted'] = 'Telah dikirim untuk dinilai';
